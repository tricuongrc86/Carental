 ...
 * @author TriCuong
 */
@WebServlet(name = "DeleteProCartServlet", urlPatterns = {"/DeleteProCartServlet"})
public class DeleteProCartServlet extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(DeleteProCartServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("NOTIFICATION", "Delete cart successfully!!!");
